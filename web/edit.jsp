<%-- 
    Document   : edit
    Created on : 5-Dec-2016, 12:13:35 AM
    ...
    <body>
        <div id="container">
            ...
            <form action="${pageContext.request.contextPath}/AdminController" method="post">
                Question: <textarea rows="2" cols="80" name="q">${question}</textarea><br><br>
                Choice A: <input type="text" name="code1" value="${choice1}" size="80"><input type="checkbox" name="correct1" value="true" ${IsRight1}>Correct<br><br>
                Choice B: <input type="text" name="code2" value="${choice2}" size="80"><input type="checkbox" name="correct2" value="true" ${IsRight2}>Correct<br><br>
                Choice C: <input type="text" name="code3" value="${choice3}" size="80"><input type="checkbox" name="correct3" value="true" ${IsRight3}>Correct<br><br>
                Choice D: <input type="text" name="code4" value="${choice4}" size="80"><input type="checkbox" name="correct4" value="true" ${IsRight4}>Correct<br><br><br>
                <div id="editButton">
